...
train_movie_df = pd.read_csv('C:/Users/Poonam/Documents/Fall 2019/Deep Learning Python/DeepLearning_ICP/LAB_DL_PK/Question 5/sentiment-analysis-on-movie-reviews/train.tsv', delimiter='\t', encoding='utf-8')
test_movie_df = pd.read_csv('C:/Users/Poonam/Documents/Fall 2019/Deep Learning Python/DeepLearning_ICP/LAB_DL_PK/Question 5/sentiment-analysis-on-movie-reviews/test.tsv', delimiter='\t', encoding='utf-8')
...
# Creating the model for sentiment analysis of the movie review data
embed_dim = 128
lstm_out = 196

# Design the convolutional neural network model using LSTM classification
# Model defined
model = Sequential()
